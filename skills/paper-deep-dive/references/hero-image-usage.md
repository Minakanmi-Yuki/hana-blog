...
This is the shared cover-image allocation document for `Paper Deep Dive` posts. Read it before choosing `heroImage` and update it after assigning a cover.

## Selection Rules

1. Choose a Pixiv cover from the available pool below.
2. Prefer images with `Use Count = 1`.
3. Avoid any image already used by another `paper-deep-dive-*` post.
4. Do not use an image with `Use Count >= 3` unless the user explicitly overrides this rule.
...
|         3 | `57793944`  | `https://pic.hana0721.top/57793944_p0_master1200.4xv4u7fok2.webp`  | `paper-deep-dive-rt2`, `paper-reading-vlm2`, `paper-deep-dive-evo-0`                                                             |
|         3 | `104724685` | `https://pic.hana0721.top/104724685_p0_master1200.7p472bcti3.webp` | `rl-note-23`, `paper-deep-dive-bagel`, `paper-deep-dive-mu0`                                                                     |
|         3 | `104786218` | `https://pic.hana0721.top/104786218_p0_master1200.8vnievbkwk.webp` | `vibe-coding-2`, `paper-deep-dive-x-vla`, `paper-deep-dive-spatial-traces`                                                       |
|         3 | `105886628` | `https://pic.hana0721.top/105886628_p0_master1200.5fl6its319.webp` | `paper-deep-dive-diffusion-policy`, `rl-note-24`, `paper-deep-dive-hume`                                                         |
...
|         3 | `75863098`  | `https://pic.hana0721.top/75863098_p0_master1200.8aduokw8y2.webp`  | `rl-note-10`, `robotic-grasp-detection-9`, `paper-deep-dive-dreamcontrol-v2`, `paper-deep-dive-rt1`                              |
|         3 | `76117294`  | `https://pic.hana0721.top/76117294_p0_master1200.2rvq8fo0ul.webp`  | `rl-note-11`, `robotic-grasp-detection-10`, `paper-deep-dive-sonic`                                                              |
|         3 | `78075718`  | `https://pic.hana0721.top/78075718_p0_master1200.51eqrx8rbi.webp`  | `rl-note-12`, `robotic-grasp-detection-11`, `paper-deep-dive-libero`                                                             |
|         3 | `78391247`  | `https://pic.hana0721.top/78391247_p0_master1200.5j4sgia4wg.webp`  | `rl-note-13`, `robotic-grasp-detection-12`, `paper-deep-dive-libero-plus`                                                        |
...
|         3 | `102841826` | `https://pic.hana0721.top/102841826_p0_master1200.4clh7xw95k.webp` | `rl-note-22`, `paper-deep-dive-inspire`, `paper-deep-dive-egoscale`, `paper-deep-dive-egolive`                                   |
...
|         3 | `56422576`  | `https://pic.hana0721.top/56422576_p0_master1200.7i0z6ufn65.webp`  | `paper-reading-vlm1`, `paper-deep-dive-chatvla-2`, `paper-deep-dive-touchworld`, `paper-deep-dive-fast-in-slow`, `paper-deep-dive-spatialvla` |
|         3 | `62258773`  | `https://pic.hana0721.top/62258773_p0_master1200.7zr0vfh0rf.webp`  | `paper-reading-cv1`, `paper-deep-dive-ace-ego-0`, `paper-deep-dive-tracevla`                                                                  |
|         3 | `64131498`  | `https://pic.hana0721.top/64131498_p0_master1200.45i9cfg3rk.webp`  | `paper-reading-eba2`, `paper-deep-dive-lap`, `paper-deep-dive-halo`                                                                           |
|         3 | `62423081`  | `https://pic.hana0721.top/62423081_p0_master1200.3ns7nvxp9b.webp`  | `paper-reading-bm1`, `paper-deep-dive-rdt2`, `paper-deep-dive-mmada-vla`                                                                      |
|         3 | `68232005`  | `https://pic.hana0721.top/68232005_p0_master1200.60uu51sjdo.webp`  | `paper-reading-llm1`, `paper-deep-dive-fast`, `paper-deep-dive-world-action-model-robustness`                                                 |
|         3 | `69461006`  | `https://pic.hana0721.top/69461006_p0_master1200.1e974ctzq9.webp`  | `paper-reading-llm2`, `paper-deep-dive-actioncodec`, `paper-deep-dive-gr00t-n1`, `paper-deep-dive-learning-while-deploying`                   |
|         3 | `69606244`  | `https://pic.hana0721.top/69606244_p0_master1200.64eg2rlm3q.webp`  | `paper-reading-marl1`, `paper-deep-dive-lapa`, `paper-deep-dive-t-rex`                                                                        |
|         3 | `70434530`  | `https://pic.hana0721.top/70434530_p0_master1200.b9htgy5uw.webp`   | `paper-reading-mllm1`, `paper-deep-dive-villa-x`, `paper-deep-dive-vla-opd`, `paper-deep-dive-tacvla`                                         |
|         3 | `70937229`  | `https://pic.hana0721.top/70937229_p0_master1200.6bhnz4ob71.webp`  | `matlab-ubuntu-24-04-install`, `paper-deep-dive-pi07`, `paper-deep-dive-omnivta`                                                              |
|         3 | `71187447`  | `https://pic.hana0721.top/71187447_p0_master1200.13mdb6lism.webp`  | `galgame-1`, `paper-deep-dive-dreamzero`, `paper-deep-dive-bagelvla`, `paper-deep-dive-twinbrainvla`, `paper-deep-dive-priorvla`              |
|         3 | `71875434`  | `https://pic.hana0721.top/71875434_p0_master1200.7pvvr603z.webp`   | `paper-reading-umllm1`, `paper-deep-dive-warp-rm`, `paper-deep-dive-mm-act`                                                                   |
|         3 | `90399055`  | `https://pic.hana0721.top/90399055_p0_master1200.4g535npbv6.webp`  | `rl-note-21`, `paper-deep-dive-internvla-a1`, `paper-deep-dive-cosmos-policy`, `paper-deep-dive-genie-envisioner`, `paper-deep-dive-lawam`    |
|         3 | `91341540`  | `https://pic.hana0721.top/91341540_p0_master1200.7pw5duffp.webp`   | `rustdesk-cli-server-setup`, `paper-deep-dive-dreamvla`, `paper-deep-dive-training-time-action-conditioning`                                  |
...
When a new post assigns a cover:

1. Increment the image's `Use Count`.
2. Add the new slug to its `Current Posts` cell.
3. Move the row to the correct pool if the count changes from 1 to 2, or from 2 to 3.
4. If a new Pixiv image is added, append it to the count-1 pool.
