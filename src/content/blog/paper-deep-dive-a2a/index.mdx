...
![回归、noise-to-action 与 A2A action-to-action 策略的比较（论文 Figure 1）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-a2a/a2a-framework-crop.4joud72m0p.webp)
...
![A2A 的视觉条件路径、历史动作 source path 与 latent Flow Net（论文 Figure 2）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-a2a/a2a-pipeline-crop.1apqgjf4ph.webp)
...
![Roboverse 中的五个仿真操控任务（论文 Figure 3）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-a2a/a2a-experiments-crop.99u3blu8xj.webp)
...
![Close Box 上的步数—成功率、单步训练收敛与各方法推理耗时（论文 Figure 7）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-a2a/a2a-inference-cost-crop.54yhzhx3aq.webp)
...
![Flow / regression 与 latent / raw action space 的结构消融（论文 Figure 10）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-a2a/a2a-structure-ablation-crop.8hh7tvdo6z.webp)
