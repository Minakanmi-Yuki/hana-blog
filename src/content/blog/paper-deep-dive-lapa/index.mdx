...
![LAPA 从视频到机器人动作的三阶段问题设定（论文 Figure 1）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-lapa/Figure1.73uooala4k.webp)
...
![LAPA 三阶段总览：Latent Action Quantization、Latent Pretraining 和 Action Finetuning（论文 Figure 2）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-lapa/latent_action_pretraining.7lkqcvmnud.webp)
...
![LAQ encoder-decoder 与 NSVQ codebook 的结构（论文 Figure 5）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-lapa/latent_action_model.b9n1tv3ay.webp)
...
![LAPA 真实机器人实验的平均成功率对比（论文 Figure 4）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-lapa/real_robot.54yhxyfski.webp)
...
![LAPA 的模型规模、数据规模与 latent space scaling 消融（论文 Figure 7）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-lapa/ablation_model_scale.4ubo4t0kjz.webp)
...
![不同离散 latent action 在视频重建中的语义对应关系（论文 Figure 8）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-lapa/latent_analysis.58i3vo8vhu.webp)
