...
![RICL 方法总览（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-ricl/ricl-overview.6po8yuc47q.webp)
...
![RICL-π₀-FAST-DROID 架构（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-ricl/ricl-architecture.4g58fcrdkt.webp)
...
![Franka DROID 实验平台与厨房水槽新场景（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-ricl/franka-droid-setup.2rvvi61363.webp)
...
![pokeball 任务的检索 query 与邻居可视化（论文 Figure 8）](https://pic.hana0721.top/blog/paper-deep-dive-ricl/retrieval-pokeball.5xbdh3vi6j.webp)
...
![pokeball 任务成功率示例（论文 Figure 5 的单任务图）](https://pic.hana0721.top/blog/paper-deep-dive-ricl/results-pokeball.2rvvi6138a.webp)
...
![idli plate 任务的示教数量消融（论文 Figure 5 右下角）](https://pic.hana0721.top/blog/paper-deep-dive-ricl/ablation-idli.1e9ce4q144.webp)
