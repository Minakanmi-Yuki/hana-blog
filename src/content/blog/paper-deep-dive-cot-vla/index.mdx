...
![CoT-VLA 与 vanilla VLA 的对比：先生成 goal image，再生成 action chunk（论文 Figure 1）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-cot-vla/teaser.6t7uuztgyt.webp)
...
![CoT-VLA 总体架构：VILA-U 先生成视觉子目标，再并行生成动作并闭环执行（论文 Figure 2）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-cot-vla/method.5q85k3xnaw.webp)
...
![CoT-VLA 的 hybrid attention：图像与文本用 causal attention，动作 token 用 full attention（论文 Figure 3）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-cot-vla/attention.1e9cckec0n.webp)
...
![CoT-VLA 在 LIBERO、Bridge-V2 和 Franka-Tabletop 上的执行示例（论文 Figure 5）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-cot-vla/rollout.9ddp7mtgmr.webp)
...
![Franka-Tabletop 六个操作任务的对比结果（论文 Figure 4）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-cot-vla/franka.lwgutxs48.webp)
...
![Action Chunking、Hybrid Attention、Visual CoT 与预训练的消融结果（论文 Figure 6）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-cot-vla/ablation.8s41lbz1mj.webp)
