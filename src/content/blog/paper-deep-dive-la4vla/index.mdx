...
![LA4VLA 的数据构造、预训练范式与结果总览（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-la4vla/main.3yf6qqia0y.webp)
...
![固定指令、干预视觉后的方向跟随轨迹（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-la4vla/visual_cue_dependence_v2.26m7vtyx9l.webp)
...
![LA-33K 的切分、标注、过滤与 action category 分布（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-la4vla/dataset_pipeline.6t7uwixh3r.webp)
...
![xArm6 上 Press Button、Place Book、Place Drink 三类语言条件任务（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-la4vla/real_world_process.1764inw6eu.webp)
...
![LA-pretrained 的方向跟随与 action-decoding 表示分离（论文 Figure 5）](https://pic.hana0721.top/blog/paper-deep-dive-la4vla/b1_la_visual.96ahdqbaj6.webp)
