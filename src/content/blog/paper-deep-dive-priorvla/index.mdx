...
![PriorVLA 总览：保留先验并比较 OOD、少样本表现（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-priorvla/overview.priorvla.webp)
...
![PriorVLA 架构：Dual Action Experts 与三类 Expert Queries（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-priorvla/architecture.priorvla.webp)
...
![PriorVLA 的 token attention mask 与信息流（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-priorvla/attention.priorvla.webp)
...
![PriorVLA 的 LIBERO、RoboTwin 2.0 与真实机器人评测覆盖（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-priorvla/setup.priorvla.webp)
