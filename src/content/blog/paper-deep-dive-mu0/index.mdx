...
![μ₀ 从视频到可复用动作先验的总览（论文 teaser）](https://pic.hana0721.top/blog/paper-deep-dive-mu0/teaser.1sfs501zw0.webp)
...
![μ₀ 与 Action Expert 接口的整体架构（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-mu0/architecture.9rk502h4dr.webp)
...
![TraceExtract 数据管线（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-mu0/pipeline.7zr655xr31.webp)
...
![真实机器人平台与任务（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-mu0/setup.232ly5h8qa.webp)
...
![真实 UR3 任务的成功率（论文 Figure 5）](https://pic.hana0721.top/blog/paper-deep-dive-mu0/real-results.8z79ic0j07.webp)
...
![μ₀ 轨迹预测的定性比较（论文 Figure 6）](https://pic.hana0721.top/blog/paper-deep-dive-mu0/qualitative.4n8gash79t.webp)
