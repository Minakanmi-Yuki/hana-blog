...
![统一联合扩散、因果扩散与 DUST 双流扩散的对比（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-dust/concept-joint.szorxxiqk.webp)
...
![三种 world-model augmented VLA 结构（论文 Figure 1，因模态拆分分别裁切）](https://pic.hana0721.top/blog/paper-deep-dive-dust/concept-causal.3d5j4kxhav.webp)
...
![DUST 双流 MMDiT 架构：冻结 VLM 条件、共享 attention 与模态专属 DiT（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-dust/architecture.7p4cc4gsnd.webp)
...
![异步 vision-action joint sampling：视觉步数可多于动作步数（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-dust/diffusion-steps.7axwl98i0s.webp)
...
![Franka Research 3 真实任务：4 个 pick-and-place、1 个 insertion、2 个 tool-use（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-dust/real-tasks.6f1f5sytmp.webp)
