...
![ST-VLA 总体架构：轨迹与深度图融合后同 RGB、语言一并送入 VLA（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-spatial-traces/st-vla-architecture.webp)
...
![三种轨迹写入深度图的方式：自身帧深度（A）、前一帧深度（B）、当前帧最近物体深度（C），论文 Figure 7）](https://pic.hana0721.top/blog/paper-deep-dive-spatial-traces/st-vla-trace-variants.webp)
...
![当前深度图、原始轨迹与写入后的轨迹深度示例（论文 Figure 8）](https://pic.hana0721.top/blog/paper-deep-dive-spatial-traces/st-vla-depth-traces.webp)
...
![SimplerEnv 中的四类 Bridge 任务与语言指令示例（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-spatial-traces/st-vla-simplerenv-tasks.webp)
...
![各方法的平均 GCS 与 SR；ST-VLA 在图中最高（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-spatial-traces/st-vla-main-results.webp)
