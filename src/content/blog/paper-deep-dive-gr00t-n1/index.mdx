...
![GR00T N1 双系统 VLA 总览（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-gr00t-n1/groot_inference_yuke_v2.wjao4p57s.webp)
...
![GR00T N1 的数据金字塔：从 web/human video 到 synthetic，再到 real-world data（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-gr00t-n1/data_pyramid.5q85k99tu7.webp)
...
![GR00T N1 模型架构：Eagle-2 VLM 与跨 embodiment DiT action head（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-gr00t-n1/groot_model_v6.9kgx37rsjt.webp)
...
![仿真任务示例：RoboCasa、DexMimicGen 与 GR-1 tabletop（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-gr00t-n1/fig_task_v6.7i14f5t73h.webp)
...
![GR-1 预训练与 post-training 任务（论文 Figure 5）](https://pic.hana0721.top/blog/paper-deep-dive-gr00t-n1/real_gr1_task_figure.45iekscnij.webp)
...
![Neural trajectory、LAPA 与 IDM 的消融结果（论文 Figure 6）](https://pic.hana0721.top/blog/paper-deep-dive-gr00t-n1/dream_figure.4xva2it8dn.webp)
