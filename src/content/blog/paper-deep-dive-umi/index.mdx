...
![UMI 硬件与示教接口（论文 Figure 2）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-umi/UMI_hardware_v2.szos3czxc.webp)
...
![UMI Policy Interface：同步观测、相对动作与延迟补偿（论文 Figure 5）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-umi/UMI-method.lwgwnquct.webp)
...
![UMI 评测任务：杯子、动态投掷、双臂折衣与洗碗（论文 Figure 7）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-umi/UMI-Task.2yz3dv4lnp.webp)

**【Paper】** 四类任务覆盖 prehensile/non-prehensile、动态、双臂、可变形物体和超长时序；每个任务在随机初始状态评估，并单独做镜头、动作空间、延迟和双臂 proprioception 消融。

### 5.2 Main Results

![UMI 窄域与野外实验结果（论文 Figure 8/9）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-umi/UMI-eval.8l0trq5x3r.webp)
...
![相对轨迹动作表示（论文 Figure 6）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-umi/UMI-Action_repr.4920k6mkyf.webp)
