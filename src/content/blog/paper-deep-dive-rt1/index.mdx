...
<img src='https://pic.hana0721.top/blog/paper-deep-dive-rt1/rt1-teaser-model-crop.webp' alt='RT-1 概览（论文 Figure 1）' class='zoomable' width='1796' height='1117' loading='lazy' decoding='async' style='max-width:100%; height:auto;' />
...
![RT-1 完整架构：USE、FiLM-EfficientNet、TokenLearner 与 Transformer（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-rt1/rt1-full-model-crop.webp)
...
![RT-1 的训练教室、真实厨房和移动机械臂（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-rt1/robot-setup-crop.webp)
...
![RT-1 与 Gato、BC-Z 的成功率（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-rt1/main-baselines-crop.webp)
...
![数据量与数据多样性消融（论文 Figure 5）](https://pic.hana0721.top/blog/paper-deep-dive-rt1/data-ablation-crop.webp)
...
![RT-1 在模拟物体和跨机器人数据上的迁移结果（论文 Figure 6）](https://pic.hana0721.top/blog/paper-deep-dive-rt1/sim-delta-crop.webp)
