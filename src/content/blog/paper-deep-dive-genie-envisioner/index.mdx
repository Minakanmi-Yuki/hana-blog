...
![Genie Envisioner 平台总览（论文 Figure 1）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-genie-envisioner/Banner.2h91oxadkq.webp)
...
![GE-Base 的多视角 autoregressive world model 与 cross-view causal block（论文 Figure 2）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-genie-envisioner/GE-Base.8dxlvxl63q.webp)
...
![GE-Act 的 parallel action branch 与 flow-matching decoder（论文 Figure 5）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-genie-envisioner/GE-Act.icuykz4za.webp)
...
![GE-Sim 的 Pose2Image、motion token 与 action-conditioned video generation（论文 Figure 8）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-genie-envisioner/GE-Sim.3gp5237eqv.webp)
...
![GE-Act 的 text-video-policy 三阶段训练流程（论文 Figure 6）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-genie-envisioner/Train-Action.6t7uwgnyym.webp)
...
![AgiBot G1 上 GE-Act 与 VLA baselines 的 SR/E2E 对比（论文 Figure 7）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-genie-envisioner/Exp-SR-E2E-iclr.3rbyv8mn24.webp)
...
![不同 embodiment 上的任务成功率对比（论文 Figure 10）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-genie-envisioner/Exp-crossbody-iclr.6po8yquwt7.webp)
...
![EWMBench 对多个视频世界模型的多维度比较（论文 Figure 12）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-genie-envisioner/Exp-8metric-v2.2h91ox4nvx.webp)
