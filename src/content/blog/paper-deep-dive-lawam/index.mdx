...
![LaWAM 两阶段训练与推理总览（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-lawam/lawam-overview.4920k1cypw.webp)
...
![一个 action chunk 内的 latent subgoal 引导执行（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-lawam/libero-chunk.64elcnpejx.webp)
...
![真实机器人任务：抓取放置、打开抽屉和折叠毛巾（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-lawam/real-world.5xbdh83954.webp)
...
![LIBERO 上的延迟—成功率权衡（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-lawam/libero-latency.102wndphfb.webp)

### 5.3 Ablation Study

![LaWAM 组件消融：预训练、distillation、Knowledge Insulation 与 LaWM（论文 Figure 6）](https://pic.hana0721.top/blog/paper-deep-dive-lawam/ablation.2yz3dpuzpg.webp)
...
![混合控制频率训练与 physical-time encoding（论文 Appendix Figure）](https://pic.hana0721.top/blog/paper-deep-dive-lawam/mixed-frequency.3d5j4l3aol.webp)
...
![500 条 LIBERO 轨迹上的 LaWM rollout 特征相似度（论文 Appendix Figure）](https://pic.hana0721.top/blog/paper-deep-dive-lawam/lawm-rollout.99u3bljtl5.webp)
