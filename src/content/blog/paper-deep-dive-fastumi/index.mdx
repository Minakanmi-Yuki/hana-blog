...
![FastUMI 手持设备与机器人端设备总览（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-fastumi/fastumi-overview.webp)
...
![T265 到 TCP、基座坐标与偏移的变换示意（论文 Figure 6）](https://pic.hana0721.top/blog/paper-deep-dive-fastumi/fastumi-transformation.webp)
...
![FastUMI 数据集任务与示教数量分布（论文 Figure 8）](https://pic.hana0721.top/blog/paper-deep-dive-fastumi/fastumi-dataset.webp)

![12 个真实机器人评测任务（论文 Figure 9）](https://pic.hana0721.top/blog/paper-deep-dive-fastumi/fastumi-tasks.webp)
...
![Depth-Enhanced DP 的深度映射过程（论文 Figure 7）](https://pic.hana0721.top/blog/paper-deep-dive-fastumi/fastumi-depth.webp)
