...
![PLD 三阶段框架：残差 RL、混合轨迹收集与 SFT 蒸馏（论文 Figure 3）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-pld/pld-framework.8okfp46at7.webp)
...
![PLD 残差 RL 在 8 个 LIBERO 任务上的训练曲线（论文 Figure 4）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-pld/method-compare-1.3rbyv9sivv.webp)
...
![Base-policy probing 比例消融：探测到约 0.6 后性能饱和（论文 Figure 12）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-pld/probing-ratio-1.3k8qzu6dpd.webp)
...
![探测状态与恢复动作带来的真实世界失败模式覆盖（论文 Figure 10）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-pld/real-world-low-1.67y7a6zf6o.webp)
