...
![SIM1 的 real-to-sim-to-real 总览（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-sim1/figure-1.8vnnkw9qpr.webp)
...
![SIM1 三阶段框架：场景数字化、变形稳定物理模拟与结构化轨迹合成（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-sim1/figure-2.1e9ceeyib7.webp)
...
![AVBD 应变约束与双向行为校准（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-sim1/figure-3.7w7k7q9hm6.webp)
...
![SIM1 的真实/仿真采集与泛化评测设置（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-sim1/figure-4.2h91pb43bj.webp)
...
![SIM1 生成的多衣物、多任务与多环境资产（论文 Figure 5）](https://pic.hana0721.top/blog/paper-deep-dive-sim1/figure-5.5flbst2lr0.webp)

### 5.2 Main Results

![真实机器人 zero-shot sim-to-real 部署与跨衣物泛化（论文 Figure 9）](https://pic.hana0721.top/blog/paper-deep-dive-sim1/figure-9-10.9o0j2msuoc.webp)

**【Paper】** 主要结果如下：

![SIM1 的 in-domain 与 out-of-domain 成功率（论文 Figure 7）](https://pic.hana0721.top/blog/paper-deep-dive-sim1/figure-7.96ahe1rh03.webp)
...
![SIM1 的数据规模曲线与模块效果（论文 Figure 8）](https://pic.hana0721.top/blog/paper-deep-dive-sim1/figure-8.7p4ccancb0.webp)
