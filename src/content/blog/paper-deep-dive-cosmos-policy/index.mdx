...
<img
  src='https://pic.hana0721.top/blog/paper-deep-dive-cosmos-policy/overview.7lkqe73l1z.webp'
...
![Cosmos Policy 的 latent frame injection：把动作、未来状态和值插入视频扩散序列（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-cosmos-policy/latent-injection.8dxlvxk6jh.webp)
...
![ALOHA 真实双臂任务的 Cosmos Policy rollout（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-cosmos-policy/aloha-results.7i14ghahla.webp)
...
![Cosmos Policy 与 VLA、Diffusion Policy 在 ALOHA 上的任务完成度（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-cosmos-policy/aloha-results.7i14ghahla.webp)
...
![联合训练的 50% / 25% / 25% balanced batches（论文 Figure 12）](https://pic.hana0721.top/blog/paper-deep-dive-cosmos-policy/balanced-batches.2vfhfsby0j.webp)
...
![基础模型与 rollout 微调模型的规划结果对比（论文 Figure 7）](https://pic.hana0721.top/blog/paper-deep-dive-cosmos-policy/planning-results.3gp5236f1i.webp)
