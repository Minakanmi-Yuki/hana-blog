...
![SIMPLER 环境与真实评测的总体流程（论文 Figure 2）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-simpler/fig2.8adzyiudiv.webp)
...
![SIMPLER 的控制与视觉 gap 修正组件（论文 Figure 2）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-simpler/fig2.8adzyiudiv.webp)
...
![系统辨识前后，仿真机器人对真实轨迹的跟踪差异（论文 Figure 3）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-simpler/control_gap.9kgx4uccst.webp)
...
![Visual Matching：真实背景绿幕与前景纹理烘焙（论文 Figure 4）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-simpler/visual_matching.5q85lvuf0m.webp)
...
![BridgeData V2 上真实与仿真成功率（论文 Figure 6）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-simpler/results_bridge.mtab01fh.webp)
...
![SIMPLER 的 real-sim 策略排序散点图（论文 Figure 1）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-simpler/fig1_scatterplot.86ue0t1asd.webp)

**【Analysis】** 结果支持的不是“仿真成功率就是现实成功率”，而是“SIMPLER 的排序错误通常只发生在现实成功率接近的策略之间”。这正是 MMRV 比单纯 Pearson 更适合 checkpoint selection 的原因。

### 5.3 Ablation Study

![不同分布偏移下的成功率变化（论文 Figure 8）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-simpler/results_dist_shifts_google_robot.3uvkt9hzdd.webp)
...
![SAPIEN 与 Isaac Sim 的比较（论文 Figure 10）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-simpler/results_simulators.7w7k7nm2r8.webp)
