...
![MimicGen 系统流程：示教切段、片段变换与新轨迹执行（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-mimicgen/system-overview.mimicgen.webp)
...
![MimicGen 的 reset distribution 与真实机器人 Stack 示例（论文 Figure 6）](https://pic.hana0721.top/blog/paper-deep-dive-mimicgen/reset-d0.mimicgen.webp)
...
![MimicGen image-based agent 的 source、生成数据与数据规模对比结果（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-mimicgen/core-results.mimicgen.webp)
...
![真实机器人 Stack 任务示例（论文 Figure 6 右侧子图）](https://pic.hana0721.top/blog/paper-deep-dive-mimicgen/real-stack.mimicgen.webp)
