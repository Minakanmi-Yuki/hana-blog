...
![EgoScale 两阶段人类到机器人学习流程（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-egoscale/pull_figure-egoscale.webp)
...
![EgoScale flow-based VLA 架构（论文 Figure 2b）](https://pic.hana0721.top/blog/paper-deep-dive-egoscale/architecture-egoscale.webp)
...
![EgoScale 人类数据采集与模型输入（论文 Figure 2a）](https://pic.hana0721.top/blog/paper-deep-dive-egoscale/ego_data_collection-egoscale.webp)
...
![EgoScale 的五个灵巧操作评测任务（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-egoscale/dexterous_manipulation_tasks_v2-egoscale.webp)
...
![主要任务完成分数与成功率（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-egoscale/success_rate_task_completion_bar_plot-egoscale.webp)
...
![人类数据规模、验证损失和机器人性能的关系（论文 Figure 5）](https://pic.hana0721.top/blog/paper-deep-dive-egoscale/human_data_scaling_combined-egoscale.webp)
...
![不同人类手部动作表示的消融（论文 Figure 8）](https://pic.hana0721.top/blog/paper-deep-dive-egoscale/human_action_space_completion_barplot-egoscale.webp)
...
![Aligned mid-training 带来的 one-shot transfer（论文 Figure 6）](https://pic.hana0721.top/blog/paper-deep-dive-egoscale/midtraining_v2-egoscale.webp)
...
![Unitree G1 tri-finger 跨 embodiment 结果（论文 Figure 7）](https://pic.hana0721.top/blog/paper-deep-dive-egoscale/g1taskandsuccess_v3-egoscale.webp)
