...
![ACE-Ego-0 将机器人、仿真和第一视角人类视频统一到同一个 VLA 预训练框架（论文 teaser）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-ace-ego-0/teaser.lwguwp2rt.webp)
...
![ACE-Ego-0 总体架构：Qwen3-VL 提供视觉语言表示，带 morphology token 的 action expert 通过 flow matching 输出 camera-space action（论文 Figure 2）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-ace-ego-0/method.5c1ptbgpa8.webp)
...
![将原始第一视角视频转为 camera-space pseudo-actions 的五阶段管线（论文 Figure 4）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-ace-ego-0/data_pipeline.7axwjnm7n1.webp)
...
![ACE-Ego-0 预训练数据处理概览：从视频筛选、手部重建到质量控制（论文 Figure 3）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-ace-ego-0/data_pipeline.7axwjnm7n1.webp)
...
![ARX 真实双臂任务结果：ACE-Ego-0 与 π0.5、GR00T-N1.7 的比较（论文 Figure 7a）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-ace-ego-0/real_robot_bar_repro.77ealxt4z8.webp)
...
![RoboCasa 组件消融：移除 morphology、时间对齐或 reliability-aware loss 的性能下降（论文 Figure 7b）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-ace-ego-0/ablation_waterfall_repro.83as1e2tgk.webp)
...
![Sweep Cubes 微调数据的动作覆盖：机器人示教、人类视频和叠加分布（论文 Figure 8）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-ace-ego-0/coverage_A_trajectories.szoqcb8hx.webp)
