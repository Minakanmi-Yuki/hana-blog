...
![不同固定 chunk size 对 RoboCasa 任务成功率的影响（论文 Figure 1）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-adaptive-action-chunking/aac-fixed-chunk-results.webp)
...
![AAC 系统总览：GR00T 生成多条候选 chunk，AAC 依据 action entropy 决定执行长度（论文 Figure 2）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-adaptive-action-chunking/aac-method.webp)
...
![AAC 在 LIBERO-Spatial 任务中的 chunk size 决策分布（论文 Figure 4）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-adaptive-action-chunking/aac-simstep.webp)
...
![AAC rollout 中不同语义阶段的 chunk size：接近物体和抓取阶段更短（论文 Figure 3）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-adaptive-action-chunking/aac-chunk-rollout.webp)
...
![真实机器人上的香蕉、紧急按钮和长时抽屉任务（论文 Figure 5）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-adaptive-action-chunking/aac-real-world.webp)
