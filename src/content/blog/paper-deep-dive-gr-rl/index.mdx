...
![GR-RL 鞋带任务与三阶段训练流程（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-gr-rl/gr_rl_main.4joud0b2bb.webp)
...
![GR-RL 的 Mixture-of-Transformer 架构：VLA、Action Diffusion Transformer 与 Critic（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-gr-rl/model_arch.70b2rxhzol.webp)
...
![成功轨迹上的学习到的任务进度示例（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-gr-rl/progress_main.5q85lm01a1.webp)
...
![ByteMini-v2：7-DoF 双臂移动操作机器人（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-gr-rl/bm_v2.b9n36l10r.webp)
...
![GR-RL 各训练阶段成功率及在线曲线（论文 Figure 5）](https://pic.hana0721.top/blog/paper-deep-dive-gr-rl/main_metric.8s41mu1g3c.webp)
...
![分布式与非分布式 critic 的进度预测对比（论文 Figure 6）](https://pic.hana0721.top/blog/paper-deep-dive-gr-rl/progress_ablation.9kgx4ki3os.webp)

![不同训练阶段的中间步骤成功率（论文 Figure 5）](https://pic.hana0721.top/blog/paper-deep-dive-gr-rl/bar_stage_label.3nscxk1jmc.webp)
