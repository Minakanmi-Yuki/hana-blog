...
![ForceVLA2 的整体框架（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-forcevla2/2-crop.webp)
...
![ForceVLA2-Dataset 的任务与模态示意（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-forcevla2/3_rename-crop.webp)
...
![数据采集系统：Flexiv、GELLO、相机与末端力传感器（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-forcevla2/4-crop.webp)
...
![典型任务的定性结果与过载规避（论文 Figure 5）](https://pic.hana0721.top/blog/paper-deep-dive-forcevla2/5-crop.webp)
...
![Cross-Scale MoE 与 Force Prompt 的组件消融（论文 Table 2 / Figure 6）](https://pic.hana0721.top/blog/paper-deep-dive-forcevla2/6_2-crop.webp)
