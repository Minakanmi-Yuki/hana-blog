...
![CLAP 从机器人和人类视频学习对齐 latent action 的概览（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-clap/teaser-crop.b9n1vsd5y.webp)
...
![CLAP 的四阶段 pipeline：Act-VAE、VD-VAE、CLAP-NTP 和 CLAP-RF（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-clap/pipeline-crop.9ddp7u3b25.webp)
...
![Knowledge Matching：用 token-level KL 约束 RF action head 的适配（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-clap/km-crop.39lx5e0mpb.webp)
...
![Astribot S1 双臂机器人、相机与 VR teleoperation 数据采集设置（论文 Figure 5）](https://pic.hana0721.top/blog/paper-deep-dive-clap/data_setup-crop.3k8qyjfuuv.webp)

![CLAP 在真实世界任务中的部署流程（论文 Figure 6）](https://pic.hana0721.top/blog/paper-deep-dive-clap/real_task-crop.lwgv17lfw.webp)
...
![VD-VAE action features 的 t-SNE：加入 contrastive loss 后同语义动作聚类更紧（论文 Figure 9）](https://pic.hana0721.top/blog/paper-deep-dive-clap/tsne_vis-crop.4n8g9fbork.webp)
