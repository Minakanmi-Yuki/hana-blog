...
![OpenVLA-OFT+ 与 ACT、Diffusion Policy、RDT-1B、$\pi_0$ 在 ALOHA 四个任务上的完成分数（论文 Figure 4）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-openvla-oft/aloha-results.5xbdcx49r8.webp)
...
<Aside type='note' title='阅读提示'>
  ...
  表示基于论文和代码的分析推断。论文 Figure 1、2、3、4、8 已裁剪并上传；FiLM 图现使用
  包含完整示意图与图注的版本。
</Aside>
