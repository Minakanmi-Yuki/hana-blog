...
<img
  src='https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-openvla-oft/openvla-oft-overview.9rk4vvm852.webp'
...
![OpenVLA-OFT 的并行解码、动作表示和 FiLM 设计（论文 Figure 2）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-openvla-oft/design-decisions.7zr60z2uwk.webp)
...
![OpenVLA-OFT+ 在视觉 Transformer 中插入 FiLM 的实现（论文 Figure 7）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-openvla-oft/film.pg2pxb9yu.webp)
...
![LIBERO 四个任务套件与任务变化因素（论文 Figure 3）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-openvla-oft/libero-tasks.et8wrw226.webp)
...
![OpenVLA-OFT+ 与 ACT、Diffusion Policy、RDT-1B、$\pi_0$ 在 ALOHA 四个任务上的完成分数（论文 Figure 8）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-openvla-oft/aloha-results.5xbdcx49r8.webp)
...
<Aside type='note' title='阅读提示'>
  ...
  表示基于论文和代码的分析推断。论文 Figure 1、2、3、7、8 已裁剪并上传；由于图床 CDN
  尚未刷新，正文暂使用 GitHub Raw URL 作为可用 fallback。
</Aside>
