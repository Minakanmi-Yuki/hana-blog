...
![ActionCodec 总览与 LIBERO 训练曲线（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-actioncodec/figure1.8dxlulzblh.webp)
...
![ActionCodec 的 Perceiver-like VQ tokenizer 架构（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-actioncodec/arch.45ieks92x9.webp)
...
![视觉语言对齐与 latent 结构（论文 Figure 5）](https://pic.hana0721.top/blog/paper-deep-dive-actioncodec/vl_align.5mojmjd7ov.webp)
...
![ActionCodec 的仿真与真实机器人评测任务（论文 Figure 7）](https://pic.hana0721.top/blog/paper-deep-dive-actioncodec/benchmarks.7p4calbt0n.webp)
...
![独立 token、Self-Attention 与 Causal 架构的误差传播实验（论文 Figure 6）](https://pic.hana0721.top/blog/paper-deep-dive-actioncodec/grammar.8okfnrek4k.webp)
...
![RVQ post-training：冻结主 codebook 后增加 residual codebook（论文 Appendix Figure）](https://pic.hana0721.top/blog/paper-deep-dive-actioncodec/RVQft.5c1ptdxzvu.webp)
