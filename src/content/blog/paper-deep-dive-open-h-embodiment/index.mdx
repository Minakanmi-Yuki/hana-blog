...
![Open-H 数据集与两条基础模型路线（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-open-h-embodiment/overview.webp)
...
![Open-H 的机构、机器人、任务和两条模型路线（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-open-h-embodiment/overview.webp)
...
![Open-H 数据组成：平台、环境和任务分布（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-open-h-embodiment/dataset-composition.webp)
...
![GR00T-H 在 dVRK、Versius 与 MIRA 上的评估设置（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-open-h-embodiment/eval-setups.webp)
...
![SutureBot 端到端任务生存率与 OOD 结果（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-open-h-embodiment/subtask-survival.webp)
...
![GR00T-H 的跨具身成功率（论文 Figure 6）](https://pic.hana0721.top/blog/paper-deep-dive-open-h-embodiment/gr00t-h-multi-embodiment.webp)
...
![GR00T-H 在 29 个离体缝合子任务上的成功率（论文 Figure 7）](https://pic.hana0721.top/blog/paper-deep-dive-open-h-embodiment/gr00t-h-exvivo.webp)
...
![C-H-S-S 在 benchtop 与 tissue-based 数据上的 L1/SSIM（论文 Figure 8）](https://pic.hana0721.top/blog/paper-deep-dive-open-h-embodiment/cosmos-results.webp)
