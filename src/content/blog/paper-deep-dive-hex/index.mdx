...
![HEX 系统总览：跨形态数据、VLA 与全身控制器（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-hex/teaser-crop.1apqexan65.webp)
...
![HEX 高层 VLA 架构：VLM、UPP 和 Action Expert（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-hex/model-crop.7p4caisj91.webp)
...
![UPP、MoE 与 Action Expert 的细节（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-hex/model_details-crop.mt8lsnge.webp)
...
![真实机器人遥操作数据采集设置（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-hex/hardware-crop.54yhxvskjj.webp)
...
![延迟与成功率的权衡（论文 Figure 11）](https://pic.hana0721.top/blog/paper-deep-dive-hex/latency-crop.6f1f47ajwf.webp)

**【Paper】** 在 RTX 4090 上，HEX 以 73.34 ms 延迟取得 79.8% 成功率；它不是最低延迟模型，但在实际推理预算下提供最高成功率。

### 5.3 Ablation Study

![预训练与组件消融（论文 Figure 9）](https://pic.hana0721.top/blog/paper-deep-dive-hex/ablation_all-crop.1apqexal8f.webp)
...
![分布外泛化任务（论文 Figure 7）](https://pic.hana0721.top/blog/paper-deep-dive-hex/generalization_tasks-crop.4joubky3pa.webp)

![分布外泛化结果（论文 Figure 8）](https://pic.hana0721.top/blog/paper-deep-dive-hex/generalization-crop.3gp50p29p5.webp)
