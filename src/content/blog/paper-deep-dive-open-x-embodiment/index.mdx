...
![Open X-Embodiment 数据与机器人多样性总览（论文 Figure 1）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-open-x-embodiment/oxe-overview.7sny9zvf5j.webp)
...
![RT-1-X 与 RT-2-X 架构及离散动作输出（论文 Figure 3）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-open-x-embodiment/rtx-architecture.86ue0v3qzc.webp)
...
![OXE 数据集构成：数据集、embodiment、轨迹、技能与对象多样性（论文 Figure 2）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-open-x-embodiment/oxe-overview.7sny9zvf5j.webp)
...
![RT-1-X 在五个小数据域及均值上的成功率比较（论文 Figure 4）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-open-x-embodiment/rt1x-results.pg2udq06r.webp)
...
![RT-2-X 跨 embodiment emergent skills 任务示例（论文 Figure 5）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-open-x-embodiment/rt2x-emergent.58i3xcvhff.webp)
