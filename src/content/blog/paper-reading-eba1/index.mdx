...
<ArxivRating id='2308.16911' tldr='3D 点云版本的 VLM' rank={3}>
...
<ArxivRating id='2305.15021' tldr='借助 Q-Former 将 Planning 引入到 Action 决策中' rank={2}>
...
<ArxivRating id='2311.01977' tldr='使用 Trajectory 代替 Instruction 的 RT-1' rank={2}>
...
<ArxivRating id='2407.15208' tldr='首先基于 Object 生成 Flow，然后用于生成 low-level policy' rank={3}>
