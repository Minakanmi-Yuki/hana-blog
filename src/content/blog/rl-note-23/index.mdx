...
heroImage: { src: 'https://pic.hana0721.top/104724685_p0_master1200.7p472bcti3.webp', color: '#8C8275' }
tags:
  - '强化学习'
  - 'RL笔记'
  - '值分解'
...
- **训练时**：我们最小化 $Q_{tot}$ 与真实回报的 TD 误差：
  ...
  注意：这里的 $\max*{\mathbf{u}'} Q\_{tot}$ 可以很容易计算，因为 $\max \sum Q_i = \sum \max Q_i$。
