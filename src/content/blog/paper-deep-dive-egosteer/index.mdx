...
![EgoSmith、Robot Stack 与 EgoSteer 的全栈系统（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-egosteer/Teaser.5q85lxzbqq.webp)
...
![EgoSteer 模型架构：Qwen3-VL、Action Expert 与训练期 World Model（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-egosteer/model-arch.5xbdhdlgro.webp)
...
![EgoSmith 四阶段数据处理流水线（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-egosteer/pipeline_recreated_editable.5c1pv2r0c2.webp)
...
![统一机器人栈支持遥操作、推理和人工纠错（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-egosteer/robot-stack.7sny9zxwic.webp)
...
![七类灵巧操作任务与双手机器人设置（论文 Figure 5）](https://pic.hana0721.top/blog/paper-deep-dive-egosteer/teleop_task_7x6.5q85lxzbqq.webp)
...
![40 个任务上的成功率与类别分布（论文 Figure 6）](https://pic.hana0721.top/blog/paper-deep-dive-egosteer/main_exp_visualization.7sny9zxwne.webp)
...
![预训练规模、DAgger、基线和组件消融结果（论文 Figure 7 / Table 1）](https://pic.hana0721.top/blog/paper-deep-dive-egosteer/scaling_law_visualization.et918d91t.webp)
