...
description: '详解强化学习中的动态规划（DP）方法，涵盖策略迭代与价值迭代的算法原理、贝尔曼算子的收敛性证明（Banach不动点定理）及DP方法的局限性分析。'
heroImage: { src: 'https://pic.hana0721.top/70217040_p0_master1200.77e5dp0f1s.webp', color: '#8C8275' }
tags:
  - '强化学习'
  - 'RL笔记'
  - '动态规划'
