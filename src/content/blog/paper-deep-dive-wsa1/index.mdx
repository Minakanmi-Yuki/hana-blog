...
![WSA1 的数据配方与三层闭环概览（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-wsa1/overview-crop.szoryhhgr.webp)
...
![VLA、WAM 与 WSA 的建模范式对比（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-wsa1/paradigms-crop.7p4cc50rnv.webp)
...
![WSA1 的 Mixture-of-Transformers 与注意力依赖规则（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-wsa1/framework-crop.2dpfrfeoub.webp)
...
![WSA 三种联合目标的消融结果（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-wsa1/wsa_study-crop.7w7k7kmxei.webp)
...
![WSA 预训练与后训练策略消融（论文 Figure 5）](https://pic.hana0721.top/blog/paper-deep-dive-wsa1/pretrain_study-crop.39lx6vodjf.webp)
...
![WSA1 的视觉子目标、3D 世界预测与动作执行可视化（论文 Figure 6）](https://pic.hana0721.top/blog/paper-deep-dive-wsa1/vis_study-crop.2vfhg0g2rq.webp)
