...
![X-VLA 总览：Soft Prompt、可扩展预训练与跨本体适配（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-x-vla/intro_small.54yhv9zq5y.webp)
...
![X-VLA 详细架构：Florence 编码器、动作流和 Soft Prompt 共同进入 Transformer（论文 Figure 1 中的 architecture）](https://pic.hana0721.top/blog/paper-deep-dive-x-vla/archi.8okfl32fwx.webp)
...
![X-VLA 评测设置：跨本体、跨环境、跨任务与真实机器人（论文 Figure 6）](https://pic.hana0721.top/blog/paper-deep-dive-x-vla/all_setup.67y765vjv8.webp)
...
![仿真 benchmark 汇总结果（论文 Figure 6 / Table 2）](https://pic.hana0721.top/blog/paper-deep-dive-x-vla/all_bench.6m4mx13unv.webp)
...
![真实机器人结果：WidowX、Agilex 与 AIRBOT（论文 Figure 7）](https://pic.hana0721.top/blog/paper-deep-dive-x-vla/real_exp.4xv9zudkty.webp)

![Soft-Fold 双臂布料折叠任务与数据采集流程（论文 Appendix Figure）](https://pic.hana0721.top/blog/paper-deep-dive-x-vla/softfold.1zizwc5bgt.webp)
...
![Soft Prompt 的 t-SNE：相似硬件配置形成结构化簇（论文 Figure 8）](https://pic.hana0721.top/blog/paper-deep-dive-x-vla/tsne.4qs24erflk.webp)
...
![模型规模、数据多样性和数据量的 scaling trend（论文 Figure 5）](https://pic.hana0721.top/blog/paper-deep-dive-x-vla/scaling.4ubo24ki69.webp)
