...
![Knowledge Insulation 的 backbone、离散动作与连续 action expert 总览（论文 Figure 1）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-knowledge-insulating-vla/model_v2.pg2sow9sf.webp)
...
![论文中的训练问题与标准 VLA 的失败模式（论文 Figure 2）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-knowledge-insulating-vla/vla_problems.3gp50rie8b.webp)
...
![论文中的实验任务：items in drawer、make bed、dish in sink、shirt folding、table bussing、DROID 与 LIBERO（论文 Figure 3）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-knowledge-insulating-vla/tasks.8okfnrbdyp.webp)
...
![静态单臂 table bussing 上的性能、速度与语言跟随比较（论文 Figure 5）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-knowledge-insulating-vla/ur5_all.99u3a25ul9.webp)
...
![generalist table bussing 的训练策略与训练曲线（论文 Figure 6）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-knowledge-insulating-vla/training_curve.4xva2imj9f.webp)
...
![四个未见环境 mobile manipulation 任务的平均性能（论文 Figure 9）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-knowledge-insulating-vla/mm_end2end.4clmg7s324.webp)
