...
SceneVerse 是一个大型的 3D-VL 数据集，由 ScanNet、ARKitScenes、HM3D、3RScan、MultiScan、Structured3D、ProcTHOR 等多个 3D 数据集集合而成。为了确保不同数据源之间的一致性，处理成了 $\mathbb{R}^{N \times 8}$ 的维度，
