...
![TacVLA 总览：双目视觉、本体状态与触觉进入 VLM 和 Action Expert（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-tacvla/Main_figure_V2.4ubo67rx8w.webp)
...
![四种 constraint-locked disassembly 的几何约束（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-tacvla/Disassembly.8adzyb1k63.webp)
...
![TacVLA 的 Franka、双相机与手指触觉阵列硬件（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-tacvla/Hardware_image.51ew1ne2n3.webp)
...
![拆解与盒内抓取的时序步骤（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-tacvla/Tasks_Description_V3.92qvg1i66m.webp)
...
![相机遮挡下四个拆解任务的成功率（论文 Figure 6）](https://pic.hana0721.top/blog/paper-deep-dive-tacvla/robustness_bar_chart.4clmhmqjx1.webp)
...
![遮挡与人类干扰的鲁棒性测试流程（论文 Figure 5）](https://pic.hana0721.top/blog/paper-deep-dive-tacvla/Robustness_Demonstration.1vze2pjnup.webp)
