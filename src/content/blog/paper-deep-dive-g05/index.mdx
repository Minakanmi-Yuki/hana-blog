...
![G0.5 系统、ActionCodec、CoT 和实验结论总览（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-g05/teaser.7sny8a8q34.webp)
...
![G0.5 的单流架构与跨形态动作编码（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-g05/teaser.7sny8a8q34.webp)
...
![Structured ActionCodec：部件分组、RVQ 与 active token 序列（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-g05/tokenizer_v2.1764h94oiv.webp)
...
![G0.5 的完整 token sequence template（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-g05/token_template.9o0j0wl5w7.webp)
...
![DROID 环境与物体级 zero-shot 任务及每任务结果（论文 Figure 5/6）](https://pic.hana0721.top/blog/paper-deep-dive-g05/droid_results.39lx5b38zi.webp)
...
![Air Fryer 与 Cook Bacon 上的 AR/FM × CoT zero-shot probe（论文 Figure 11）](https://pic.hana0721.top/blog/paper-deep-dive-g05/cot_head_long_horizon.5mojmih23k.webp)
...
![GRPO 微调中 AR 与 FM 的收敛曲线（论文 Figure 12）](https://pic.hana0721.top/blog/paper-deep-dive-g05/rl_grpo.7i14f4thve.webp)
