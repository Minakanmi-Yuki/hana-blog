...
![ChatVLA-2 从训练数据、Dynamic MoE 到开放世界机器人任务的总览（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-chatvla-2/chatvla2_overview-crop.7w7k3cvtcb.webp)
...
![ChatVLA-2 的 Dynamic MoE、reasoning-following action expert 与机器人动作路径（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-chatvla-2/Structure-crop.2ksnin9qhv.webp)
...
![ChatVLA-2 的两阶段训练：Stage 1 保留开放世界理解，Stage 2 冻结 VLM 并训练 reasoning-following action expert（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-chatvla-2/Stages-crop.3k8qvtchi9.webp)
...
![数学匹配与玩具摆放的真机平台、开放世界指令和执行过程（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-chatvla-2/task-crop.1hsy7rdxuk.webp)
