...
![GrinningFace 任务总览：机器人把方块放到语言指定的 emoji 卡片上（论文 Figure 1）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-grinningface/grinningface.2h91oye4e0.webp)
...
![不同 VLA 训练数据集（OXE、Bridge、OXE-Bridge）的比较（论文 Figure 3）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-grinningface/datasets.wjaphgwuz.webp)

真实机器人使用 RM75 + Inspire gripper，验证集上每个变体 30 次试验；除直接微调 VLM 使用 20k steps 外，其余使用 5k steps。

### 5.2 Main Results

![不同预训练与微调策略在 GrinningFace 上的结果（论文 Figure 2）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-grinningface/variants.362b8z1nfv.webp)
...
![VLM、预训练 VLA 与微调 VLA 的 emoji 注意力图（论文 Figure 4）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-grinningface/attention.1zj00dcqot.webp)
