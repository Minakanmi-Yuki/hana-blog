...
![AIM 框架：联合预测未来帧、空间价值图和动作，并在第二阶段用 PPO/GRPO 类后训练优化动作头（论文 Figure 2）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-aim/framework-crop.3uvkszqxqc.webp)
...
![典型统一世界-动作模型直接从未来视觉表示解码动作，AIM 则增加空间价值图接口（论文 Figure 1）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-aim/typicalvsaim-crop.3k8qzubpqw.webp)
...
![RoboTwin 2.0 中的放置、按压、扫描、旋转和开合任务示例（论文 Figure 3）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-aim/visual-crop.szorrplqr.webp)
