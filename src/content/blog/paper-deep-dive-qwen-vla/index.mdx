...
![Qwen-VLA 从多种 embodied 数据生成动作与语言输出的总览（论文 Figure 1）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-qwen-vla/overview.7sny8cfjpm.webp)
...
![Qwen-VLA 的 Qwen3.5 VLM、DiT action expert 与四阶段训练配方（论文 Figure 2）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-qwen-vla/architecture-crop.wjao5wbfq.webp)
...
![ALOHA 真实评测的六类任务与五种 OOD 变化（论文 Figure 3）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-qwen-vla/task-overview.wjao5wbnd.webp)
...
![T2A 数据比例、timestep 分布和训练时长消融（论文补充实验图）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-qwen-vla/t2a-ablation.70b2qlz0gu.webp)
...
![VL co-training 与预训练 DiT 收敛速度消融（论文 Figure 5）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-qwen-vla/vl-ablation.2ksnlcmm67.webp)
