...
![StarVLA 的统一 VLA 形式：以动作损失为核心、以辅助预测为可选归纳偏置（论文 Figure 1）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-starvla/vla-form.icuynb422.webp)
...
![四种 action decoding 在相同 VL foundation model 接口下的实例化：FAST、OFT、GR00T 与 π（论文 Figure 2）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-starvla/frameworks.3d5j4fqaui.webp)
...
![StarVLA 将异构数据、dataloader、foundation model、action head 与训练 / 部署连成统一管线（论文 Figure 3）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-starvla/dataflow.b9n37oyr1.webp)
...
![空间 grounding 与机器人动作的 co-training 曲线：仅动作微调会快速遗忘感知能力，spatially guided co-training 更稳定（论文 Figure 4，图中研究引用自 ST4VLA）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-starvla/cotrain-curves.lwgwd470m.webp)
