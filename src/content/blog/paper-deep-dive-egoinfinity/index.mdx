...
![EgoInfinity 数据引擎总览（论文 pipeline 图）](https://pic.hana0721.top/blog/paper-deep-dive-egoinfinity/egoinfinity-pipeline.5c1pv2pjc1.webp)
...
![从重建手轨迹到跨 embodiment 运动 retargeting（论文 Figure：Retargeting pipeline）](https://pic.hana0721.top/blog/paper-deep-dive-egoinfinity/egoinfinity-retarget.4joudc8xqq.webp)
...
![EgoInfinity 的数据浏览、跨机器人 retargeting 与真实机器人示例（论文 experiments 图）](https://pic.hana0721.top/blog/paper-deep-dive-egoinfinity/egoinfinity-experiments.7q15spmc6.webp)
...
![106 段 curated Action100M 子集的时长、物体、动词与交互状态分布（论文 Figure：Dataset statistics）](https://pic.hana0721.top/blog/paper-deep-dive-egoinfinity/egoinfinity-stats.6m4n1e7j0h.webp)
