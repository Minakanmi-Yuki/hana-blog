...
<ArxivRating id='2305.11487' publication='NeurIPS2023' tldr='用自回归生成式预训练建模点云 Patch 序列，是 GPT 思路在点云表征学习中的代表。' rank={4}>
...
<ArxivRating id='2312.10035' publication='CVPR2024' tldr='强调规模化、序列化邻域映射和效率，是近年点云通用 Backbone 的强基线。' rank={4}>
