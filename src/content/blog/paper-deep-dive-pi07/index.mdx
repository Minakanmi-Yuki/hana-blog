...
![π₀.₇ 的总体思想：用丰富 context 让同一策略组合不同技能（论文 Figure 1）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-pi07/fig1.8l0tq2xq2f.webp)
...
![π₀.₇ 的 5B 架构：Gemma3 VLM、MEM history encoder、action expert 与 world model（论文 Figure 2）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-pi07/model_architecture.5j4xouwego.webp)
...
![π₀.₇ prompt 的组成：子任务、子目标图像、速度/质量/错误 metadata 可以灵活组合（论文 Figure 3）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-pi07/prompts_v4.54yhxzo3tc.webp)
...
![π₀.₇ 评测中的机器人形态：移动双臂、静态双臂、双臂 UR5e 与单臂机器人（论文 Figure 4）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-pi07/pi07robots_v5.8dxlunblru.webp)
...
![多样 context 与数据规模的消融：metadata 使混合质量数据可扩展，task diversity 提升组合泛化（论文 Figure 18）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-pi07/generalization_and_conditioning.7zr63s3csf.webp)
...
![π₀.₇ 在 UR5e 上折叠衣物的零样本跨形态迁移（论文 Figure 12/13）](https://raw.githubusercontent.com/Minakanmi-Yuki/picx-images-hosting/master/blog/paper-deep-dive-pi07/cross_embodiment.lwgv0ioib.webp)
