...
![RECAP 通过奖励反馈与人工干预训练 VLA（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-recap/teaser.54yhxzhf3t.webp)
...
![π*₀.₆ VLA 与 value function 的交互（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-recap/architecture.2ksnlchfy4.webp)
...
![论文实验任务：洗衣、纸箱装配与咖啡制作（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-recap/tasks.4920ij7ql4.webp)

![实验中的双臂机器人与三路相机（论文 Figure 5）](https://pic.hana0721.top/blog/paper-deep-dive-recap/robot.1sfs3m0um5.webp)
...
![Diverse laundry 的吞吐量结果（论文 Figure 6 中的子图）](https://pic.hana0721.top/blog/paper-deep-dive-recap/diverse-throughput.5q85kabv87.webp)
...
![严格领口朝向任务的失败模式移除结果（论文 Figure 12）](https://pic.hana0721.top/blog/paper-deep-dive-recap/failure-success.362b7nbwmj.webp)
