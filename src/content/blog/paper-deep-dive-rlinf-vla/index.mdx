...
![RLinf-VLA 系统总览（论文 Figure 1）](https://pic.hana0721.top/blog/paper-deep-dive-rlinf-vla/overview.2h91ozhq5l.webp)
...
![VLA 强化学习 rollout pipeline（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-rlinf-vla/rollout.1sfs4yu7e7.webp)
...
![Hybrid allocation with fine-grained pipeline（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-rlinf-vla/hybrid-pipeline.szorsrfr3.webp)
...
![LIBERO-130 训练曲线（论文 Figure 7）](https://pic.hana0721.top/blog/paper-deep-dive-rlinf-vla/libero.3d5j4frei7.webp)
...
![不同 GPU allocation 与 pipeline 的吞吐比较（论文 Figure 9）](https://pic.hana0721.top/blog/paper-deep-dive-rlinf-vla/efficiency.2yz3dkj359.webp)
...
![PPO 中 action-level 与 chunk-level value 的消融（论文 Figure 11）](https://pic.hana0721.top/blog/paper-deep-dive-rlinf-vla/ablation-value.4g58fbn7uw.webp)
