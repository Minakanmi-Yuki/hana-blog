...
![DreamControl-v2 四阶段系统总览（论文 Figure 2）](https://pic.hana0721.top/blog/paper-deep-dive-dreamcontrol-v2/method.dreamcontrolv2.webp)
...
![扩散模型在多种时空约束下生成的 G1 轨迹（论文附录 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-dreamcontrol-v2/diffusion-qualitative.dreamcontrolv2.webp)
...
![扩散轨迹数量对下游 RL 成功率的影响（论文 Figure 3）](https://pic.hana0721.top/blog/paper-deep-dive-dreamcontrol-v2/traj-scale.dreamcontrolv2.webp)
...
![直接在机器人空间 prompt 与人体空间试错校准的对比（论文 Figure 4）](https://pic.hana0721.top/blog/paper-deep-dive-dreamcontrol-v2/spatial-prompt.dreamcontrolv2.webp)
